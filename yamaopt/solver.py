...
class KinematicSolver:
    ...
    def configuration_constraint_from_polygon(
            self, np_polygon, normal, d_hover):
        # for pos constraint
        lin_ineq, lin_eq = polygon_to_trans_constraint(np_polygon, normal, d_hover)
        # for rpy constraint
    ...
    def base_constraint_from_polygon(self, movable_polygon):
        ...
        b_lin_ineq = polygon_to_trans_constraint(movable_polygon, None, d_hover=0.0)[0]
